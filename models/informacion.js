/*****
 * Creacion de la tabla informacion desde el ORM sequelize
...
module.exports = (sequelize, type)=>{ // Esta es una funcion sin nombre que esta siento exportado y recibe 2 parametros
    ...
    return sequelize.define('informacion',{ // Los nombres de los campos deben ser en singular NO EN PLURAL
        infoId:{                    // Campo de la tabla 
